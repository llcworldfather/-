...
export const CardReveal: React.FC<CardRevealProps> = ({ cards, onComplete }) => {
    ...
    return (
        <div className="flex flex-col items-center w-full max-w-6xl">
            <div className="flex flex-col md:flex-row gap-12 md:gap-8 mb-8 md:mb-24 items-center justify-center w-full">
                {cards.map((card, index) => {
                    ...
                    return (
                        ...
                        >
                            ...
                            <HolographicCard className="w-40 h-60 md:w-56 md:h-80">
